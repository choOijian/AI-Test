const testData = {
  images: [
    ...
    },
    {
      ...
      title: "현실의 찰나",
      isAi: false,
      src: "https://i.postimg.cc/kXR3Dmmg/a3eee3ad05f45a08633de1c8fa6a38a4.jpg",
      tagline: "일상의 클로즈업 사진",
      description: "인간 작가가 일상적인 공간의 세부를 카메라로 기록한 실제 사진입니다."
    }
  ],
  images1_5: [
    {
      ...
      title: "빛과 그림자",
      isAi: true,
      src: "https://i.postimg.cc/1t62tYyt/46a12e8a-b142-4d2a-a556-36c78fe4d0a0.png",
      tagline: "미학적 클로즈업 인물화",
      description: "피부 표면의 질감과 머리카락 한 올 한 올의 세밀한 묘사가 인상적이지만, 눈동자 속 하이라이트 형태의 미세한 흐림과 대칭 비일관성이 관찰되는 AI 이미지입니다."
    },
    {
      id: "img15_2",
      title: "오후의 시선",
      isAi: false,
      src: "https://i.postimg.cc/gjgDkvLW/e34db61e35468bd392e68b2d2a4717e5.jpg",
      tagline: "일상적인 공간의 스케치",
      description: "인물과 물체의 조화로운 그림자 배치가 돋보이는 실제 사진입니다."
    },
    {
      id: "img15_3",
      title: "도시의 흐름",
      isAi: false,
      src: "https://i.postimg.cc/6QzTPzkW/e3242be5-ed6d-479c-a500-1a7d5e4805ea.png",
      tagline: "미니멀 스트리트 아트",
      description: "인간 작가가 미니멀리즘 구도로 촬영한 도시 스트리트 사진입니다."
    },
    {
      id: "img15_4",
      title: "정갈한 식사",
      ...
      tagline: "김밥 클로즈업 사진",
      description: "인간 사진작가가 촬영한 따뜻하고 정갈한 김밥 사진입니다."
    }
  ],
  images2: [
    {
    ...
    },
    {
      ...
      tagline: "상상 속의 우주",
      description: "인간 작가가 디자인 툴을 통해 세밀하게 구상한 상상 속의 우주 디지털 일러스트입니다."
    },
    {
      id: "img2_4",
      title: "자연의 소리",
  ...
  images3: [
    ...
    },
    {
      ...
      tagline: "AI 생성 호수 풍경",
      description: "자연스러운 호수 풍경처럼 보이지만 수면에 반사되는 산맥의 비일관성과 노이즈 분포의 디지털적 불규칙함이 드러나는 AI 이미지입니다."
    },
    {
      id: "img3_3",
      title: "미래 도시 비행",
      ...
      tagline: "사이버펑크 콜라주",
      description: "인간 작가가 디지털 합성 툴을 사용해 초현실적인 구도로 촬영 및 가공한 실제 사진 아트를 콜라주한 이미지입니다."
    },
    {
      id: "img3_4",
      title: "빈티지 카페",
      ...
      tagline: "AI 생성 빈티지 카페",
      description: "필름 카메라 질감을 모방했으나 전구 조명의 물리적 투과 오류 및 테이블 모서리 선의 미세한 흐트러짐이 있는 AI 이미지입니다."
    }
  ],
  images4: [
    {
  ...
  paintings2: [
    {
      ...
      tagline: "사람이 그린 드로잉",
      description: "사람이 직접 그린 드로잉 작품입니다."
    },
    {
      id: "painting2_2",
      title: "드로잉 2",
      ...
      tagline: "AI 생성 드로잉",
      description: "AI가 생성한 드로잉 이미지입니다."
    },
    {
      id: "painting2_3",
      title: "드로잉 3",
  ...
  text: [
    {
      ...
      isAi: false,
      content: "제6호 태풍 '장미'가 발생 약 일주일 만에 태풍의 성격을 잃고 온대저기압으로 바뀌었습니다.\n\n기상청은 오늘(3일) 오후 10시에 발표한 태풍 정보에서 장미가 오늘 오후 9시에 일본 도쿄 동쪽 약 400km 부근 해상에서 온대저기압으로 변질됐다고 밝혔습니다.\n\n오후 9시 기준 온대저기압의 중심기압은 985hPa, 중심 최대풍속은 초속 23m로 분석됐습니다.\n\n지난달 27일 발생한 태풍 장미는 일본 남쪽 해상을 따라 북상해 오다, 오늘 아침 일본 간사이 남부에 상륙했습니다.\n\n위도가 높아지며 찬 공기와 만나 태풍의 특징을 잃은 것으로 보입니다.\n\n어제(2일) 새벽 남해 동부 바깥 먼바다에 태풍경보가 내려지며 장미는 올해 첫 국내 영향 태풍이자 역대 세 번째로 이른 영향 태풍으로 기록됐습니다.\n\n기상청은 장미가 온대저기압으로 바뀜에 따라 태풍 정보 제공을 마무리한다고 밝혔습니다.",
      description: "기상청 등에서 발표하는 전형적인 사실 전달형 뉴스 기사입니다."
    },
    {
      id: "text_2",
      title: "초등교사 10명 중 7명 \"정서 지도 부담 커졌다\"",
      isAi: true,
      content: "최근 전국 초등학교 교사들을 대상으로 설문조사를 진행한 결과, 응답자의 72%가 학생들의 정서 및 행동 지도에 따른 심리적 부담감이 과거에 비해 크게 증가했다고 답했다. 다수의 교사들은 학부모와의 민원 갈등 및 현행 제도적 한계가 교실 내 생활 지도를 위축시키는 주요 원인이라고 꼽았다.",
      description: "인공지능을 통해 설문 결과를 바탕으로 자동 작성된 뉴스 기사입니다."
    },
    {
      id: "text_3",
      title: "전국 편의점 매출 1위 품목은 삼각김밥 아닌 '이것'",
      isAi: true,
      content: "편의점 대표 상품으로 삼각김밥을 떠올리는 소비자가 많지만, 실제 판매 데이터에서는 다른 결과가 나타났다.\n최근 유통업계 분석에 따르면 바나나우유가 전국 편의점 음료 부문에서 가장 높은 판매량을 기록한 것으로 집계됐다.\n특히 직장인과 학생 소비층에서 꾸준한 수요를 보이며 계절과 관계없이 안정적인 판매량을 유지한 것으로 나타났다.\n업계 관계자는 \"간편하게 즐길 수 있는 익숙한 제품에 대한 선호가 꾸준히 이어지고 있다\"고 설명했다.",
      description: "독자의 클릭을 유도하기 위해 인공지능이 생성한 전형적인 낚시성 뉴스 기사입니다."
    },
    {
      id: "text_4",
      title: "하버드 출신 의사가 경고한 ‘조용히 몸 망치는 습관’ 8가지",
      isAi: false,
      content: "신체 건강은 사소한 생활 습관을 바로잡는 것에서부터 시작한다. 하버드 의과대학 출신 소화기내과 전문의 사우라브 세티는 최근 자신의 인스타그램을 통해 사람들이 흔히 저지르지만, 조용히 건강을 망치는 생활 습관 여덟 가지를 공유했다.화장실에 가기 귀찮아 소변을 참는 일은 비뇨기 건강을 해친다. 소변 배출이 지연되면 요로 감염이 생길 위험이 커지기 때문이다. 특히 여성은 남성보다 요도가 짧아 요로 감염에 취약하므로 주의가 필요하다.",
      description: "권위자의 조언을 빌려 유용한 건강 정보를 소개하는 뉴스 기사입니다."
    }
  ]
};
...
const QUESTION_STATS = [
  ...
  },
  {
    ...
    title: "이미지 테스트 2",
    type: "이미지",
    // img15_1=AI(1번), img15_2=인간(2번), img15_3=인간(3번), img15_4=인간(4번)
    answer: [1],
    totalParticipants: 120,
    correctCount: 65,
    optionSelections: { 1: 72, 2: 35, 3: 40, 4: 28 }
  },
  {
    id: "img2",
    title: "이미지 테스트 3",
    type: "이미지",
    // img2_1=AI(1번), img2_2=인간(2번), img2_3=인간(3번), img2_4=인간(4번)
    answer: [1],
    totalParticipants: 120,
    correctCount: 43,
  ...
  },
  {
    ...
    title: "드로잉 테스트",
    type: "드로잉",
    // painting2_1=인간(1번), painting2_2=AI(2번), painting2_3=AI(3번), painting2_4=AI(4번)
    answer: [2, 3, 4],
    totalParticipants: 120,
    correctCount: 61,
...
const PREVIEW_QUESTIONS = [
  ...
  },
  {
    ...
    title: "이미지 테스트 2",
    type: "image",
    options: testData.images1_5.map((item, idx) => ({ number: idx + 1, src: item.src }))
  },
  {
    id: "img2",
    title: "이미지 테스트 3",
  ...
  },
  {
    ...
    title: "기사 테스트",
    type: "article",
    options: testData.text.map((item, idx) => ({ number: idx + 1, title: item.title, content: item.content }))
  }
];
